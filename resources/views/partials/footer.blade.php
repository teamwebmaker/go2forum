...
<x-ui.modal id="support-contact-modal" title="გარე გადამისამართება" headingIcon="arrow-top-right-on-square" size="lg">
  <div class="space-y-5" data-support-contact-modal>
    ...
    <div class="flex flex-col gap-3 rounded-2xl border border-slate-200 bg-slate-50/80 p-3 shadow-sm sm:flex-row sm:items-center sm:justify-between sm:gap-4 sm:p-4">
      <div class="min-w-0 flex-1">
        <p class="truncate rounded-xl border border-slate-200 bg-white px-4 py-3 text-base font-medium text-slate-800 shadow-sm">
          {{ $supportEmail }}
        </p>
      </div>
