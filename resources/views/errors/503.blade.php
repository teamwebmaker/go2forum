...
@section('content')
    <div class="mx-auto flex w-full max-w-2xl flex-col items-center justify-center text-center">
        <div class="relative mb-8 flex h-24 w-24 items-center justify-center">
            ...
            <span class="relative text-2xl font-semibold text-primary-700">503</span>
        </div>

        <h1 class="text-3xl font-semibold text-slate-900">სერვისი დროებით მიუწვდომელია</h1>
        <p class="mt-3 text-base text-slate-600">
            {{ $message ?? 'გთხოვ, სცადე ცოტა ხანში თავიდან.' }}
        </p>
