<x-filament.trash.tab-toolbar
    :selected-count="count($selectedTopics)"
    search-id="trash-topics-search"
    search-model="topicsSearch"
    :search-placeholder="__('models.trash.search.topics_placeholder')"
>
    ...
    >
        <button
            ...
            wire:click="restoreSelectedTopics"
            x-on:click="close()"
        ...
        <button
            ...
            wire:click="forceDeleteSelectedTopicsOnly"
            x-on:click="close()"
        ...
        <thead class="bg-gray-50 dark:bg-white/5">
            <tr class="text-left">
                <th class="px-4 py-3">
                    <input
                        type="checkbox"
                        wire:model.live="selectAllTopics"
                    ...
                    <td class="px-4 py-3">
                        ...
                        >
                            <button
                                ...
                                x-on:click="close()"
                                wire:click="openDetails('topics', {{ $topic->id }})"
                            >
                            ...
                            <button
                                ...
                                class="flex w-full items-center px-3 py-2 text-left text-sm text-gray-700 hover:bg-gray-50 dark:text-gray-200 dark:hover:bg-white/5"
                                x-on:click="close()"
                                wire:click="restoreTopic({{ $topic->id }})"
                            >
...
<x-filament.trash.pagination :paginator="$this->deletedTopics" />
