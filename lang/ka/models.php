...
return [
    ...
    'conversations' => [
        ...
        'actions' => [
            'delete' => [
                ...
                'description' => 'წაშლილი საუბრები, მათში არსებული შეტყობინებები და დანართები აღდგენას არ ექვემდებარება',
            ],
            'participants' => [
                'label' => 'მონაწილეები',
    ...
    'trash' => [
        ...
        'confirmations' => [
            ...
            'force_delete_topic_with_thread' => 'დარწმუნებული ხართ, რომ გსურთ საბოლოოდ წაშლა? ამ მოქმედებით თქვენ წაშლით შეტყობინებებსაც და მათი აღდგენა შეუძლებელი იქნება',
        ],
        'notifications' => [
