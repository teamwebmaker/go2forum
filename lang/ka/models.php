...
return [
    ...
    'users' => [
        ...
        'actions' => [
            ...
            'export' => [
                'label' => 'მომხმარებლების ექსპორტი',
                'heading' => 'მომხმარებლების ექსპორტი',
                'description' => 'აირჩიეთ მომხმარებლები ექსპორტისთვის ან მონიშნეთ ყველა.',
                'users' => 'მომხმარებლები',
                'select_all' => 'ყველას არჩევა',
                'submit' => 'ექსპორტი',
                'empty' => 'გთხოვთ, აირჩიოთ მინიმუმ ერთი მომხმარებელი.',
            ],
